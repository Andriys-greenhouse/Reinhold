...
namespace MethodTestSite
{
    public class WebModule
    {
        public static async Task<string> WebSearch(string KeyWord)
        {
            ...
            {
                HttpResponseMessage response = await client.GetAsync("https://www.googleapis.com/customsearch/v1?key=AIzaSyD1zMkt3fkpb5-AArVhyLTEX4vQzgM_zl4&cx=f0aa652047963924f&q=" + KeyWord.Replace(" ", "+"));
